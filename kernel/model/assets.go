...
// Self-host fork: UploadAssets2Cloud, UploadAssets2CloudByAssetsPaths, uploadAssets2Cloud,
// bizTypeUploadAssets, bizTypeExport2Liandi, and the Liandi/b3log image-bed upload pipeline
// are removed. The /api/asset/uploadCloud* routes and the Liandi forum publish feature are
// all gone with them.
